            ...
            <div className="bg-gray-200 p-4 rounded-lg">
              <div className="flex justify-between mb-4">
                ...
                <div>
                  ...
                  <span className="ml-2 text-gray-700">Fiesta</span>
                </div>
              </div>
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-2">
                  ...
                  <div>
                    ...
                    <span className="ml-2 text-gray-700">Roberto Lewandowski</span>
                  </div>
                  
                  <div>
                    <span className="font-medium">Descripción de la revisión:</span>
                    <div className="mt-1 text-gray-700">Luego de la revisión, el vehículo se encuentra en condiciones aptas para la circulación.</div>
                  </div>
                </div>
              </div>
            </div>
